     ...
     <Container maxWidth="xl">
         <Grid item container xs={12} borderBottom={"1px solid #212529"} py={3}>
              ...
              <Grid item xs={12}  lg={3} sx={{display:"flex",justifyContent:{lg:"start",md:"center",xs:"center"}}}>
                 <Box>
                     <Box gap={2} mt={4} sx={{display:"flex",justifyContent:{lg:"start",md:"center",xs:"center"}}}>
                         <Link class="icon1 fa-brands fa-twitter" style={{padding:"10px",borderRadius:"50%",textDecoration:"none"}} to={"https://x.com/?lang=en"}></Link>
                         <Link class="icon1 fa-brands fa-youtube" style={{padding:"10px",borderRadius:"50%",textDecoration:"none"}} to={"https://www.youtube.com/"}></Link>
                         <Link class="icon1 fa-brands fa-facebook-f" style={{padding:"10px 13px",borderRadius:"50%",textDecoration:"none"}} to={"https://www.facebook.com/login.php/"}></Link>
                     </Box>
                     <Box>
         ...
         <Box py={5}>
                <Typography textAlign={"center"} sx={{color:"#BFBFBF",fontSize:{lg:"16px",md:"16px",sm:"14px",xs:"12px"},fontFamily:"'Raleway', sans-serif"}}>Copyright © 2024 Arena Lads By Evonicmedia. All Rights Reserved.</Typography>
         </Box>
     </Container>
  </Box>
  );
