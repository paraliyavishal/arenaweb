       ...
       <div className='gallery-slider' style={{}}>
        ...
        <input type='radio' name='Slider' id='s5' />
         ...
         <label for="s5" id='slider5'>
          ...
          <Button onClick={() => navigate("/gallery")} sx={{ border: '1px solid white',transition:".7s", borderRadius: '0px', padding: '10px 20px', '&:hover': { backgroundColor: '#6B5FFE',border:"1px solid rgba(44,36,74,.26)" }, color: 'white',textTransform:"unset",fontSize:{lg:"16px",md:"16px",sm:"14px",xs:"12px"},fontFamily:"'Raleway', sans-serif"}}>
              View More
          </Button>
          </Box>
      </Container>
