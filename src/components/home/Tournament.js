...
const tourna2 = [
  ...
  },
  {
    img: tournament5,
    heading:
      "Past Champions' Highlights Relive Epic Gaming Moments And Strategies.",
  },
  {
    img: tournament6,
    heading:
      "Compete And Conquer Join Upcoming Tournaments And Aim For Victory.",
  },
];
...
function Tournament() {
  ...
  return (
    <Box
      sx={{
        backgroundImage: `linear-gradient(rgba(40, 17, 43, 0.7),rgba(40, 17, 43, 0.7)),url(${tournamentbg})`,
      ...
      <Container maxWidth="xl">
        <Box pt={10} sx={{ backgroundAttachment: "fixed" }}>
          ...
          >
            ...
            industry. Has been the industry's
          </Typography>
          <Typography
            sx={{
              color: "#BFBFBFBF",
        ...
        <Grid item container xs={12} spacing={3} py={3}>
          <Grid item xs={12} md={12} lg={6}>
            ...
            >
              <Box
                border={"2px solid #221C3E"}
                sx={{ ":hover": { borderColor: "#30D855" }, transition: ".5s" }}
              >
                <Card
                  sx={{
                    backgroundImage: `linear-gradient(rgba(13, 19, 38, 0),rgba(34, 28, 62, 0.7)),url(${tournament1})`,
                    backgroundSize: "cover",
                    height: "395px",
                    borderRadius: "0px",
                    display: "flex",
                  ...
                  <CardContent>
                    <Box>
                      ...
                      <Typography
                        ...
                        py={1}
                      >
                        Lorem ipsum dolor sit amet consectetur. Porta magnis sed
                        non in.
                      </Typography>
                    </Box>
                    <Box
            ...
            <Grid item xs={12} md={6} lg={3}>
              ...
              >
                <Box
                  border={"2px solid #221C3E"}
                  sx={{
                    ":hover": { borderColor: "#30D855" },
                    transition: ".5s",
                  }}
                >
                  <Card
                    sx={{
                      backgroundImage: `linear-gradient(rgba(13, 19, 38, 0),rgba(34, 28, 62, 0.7)),url(${item.img})`,
                      backgroundSize: "cover",
                      height: "395px",
                      borderRadius: "0px",
                      display: "flex",
                    ...
                    <CardContent>
                      <Box>
                        ...
                        <Typography
                          ...
                          py={1}
                        >
                          Lorem ipsum dolor sit amet consectetur. Porta magnis
                          sed non in.
                        </Typography>
                      </Box>
                      <Box
