...
function Matches() {
  return (
    <Box
      sx={{ backgroundColor: "#090329", height: "100%", paddingBottom: "50px" }}
    >
      <Container>
        <Box display={"flex"} justifyContent={"center"}>
          <Box textAlign={"center"} paddingTop={5}>
            ...
            >
              PLAN YOUR EPIC MATCHES
            </Typography>
            <Typography
              fontWeight={500}
              sx={{
                fontSize: { lg: "28px", md: "28px", sm: "22px", xs: "20px" },
                color: "#30D855",
                marginBottom: "20px",
                fontFamily: "'Rajdhani', sans-serif",
              }}
