                                ...
                                <Grid item xs={12} sm={10} md={6} lg={4} sx={{ display: "flex", alignItems: "center", justifyContent: "center",borderBottom:{xs:"none",sm:"none",md:"none",lg:"2px solid #221C3E"}}}>
                                    <Box textAlign="center">
                                        ...
                                        <Box display="flex" alignItems="center" justifyContent="center" gap={3}>
                                            <i class="fa-brands fa-youtube" style={{color:"#BFBFBF",cursor:"pointer",}}></i>
                                            <i class="fa-brands fa-twitch" style={{color:"#BFBFBF",cursor:"pointer",}}></i>
                                            <i class="fa-brands fa-discord" style={{color:"#BFBFBF",cursor:"pointer",}}></i>
                                        </Box>
                                    </Box>
                                </Grid>
