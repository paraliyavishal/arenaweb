...
function Digitalrealms() {
  ...
  return (
      <Box sx={{backgroundImage:`linear-gradient(rgba(40, 17, 43, 0.7),rgba(40, 17, 43, 0.7)),url(${craftersbg1})`,backgroundAttachment:"fixed",width:"100%",height:"600px",backgroundSize:"cover"}}>
          <Container maxWidth='xl'>
                    <Grid item container xs={12} spacing={2} sx={{display:"flex",justifyContent:{md:"center",sm:"center",xs:"center"},backgroundAttachment:"scroll"}}>
                        <Grid item xs={12} sm={12} md={8} lg={6} alignItems={"center"} sx={{display:"flex"}} py={5}>
                             <Box ref={statsRef}>
                                   <Typography
                                      fontWeight={900}
                                      variant="h2"
                                 ...
                                 <Box gap={3} alignItems={"center"} sx={{display:{lg:"flex",md:"flex",sm:"flex",xs:"block"},justifyContent:{md:"center",sm:"center",xs:"center"}}}>
                                      <Box textAlign={"center"} padding={"10px 0px 40px 0px"}>
                                          <Box className='maintext' >
                                             <Typography className='text-1' variant='h1' fontWeight={700} sx={{marginBottom:{lg:"-30px",md:"-30px",sm:"-30px",xs:"-20px"},fontSize:{lg:"96px",md:"96px",sm:"66px",xs:"36px",fontFamily:"'Raleway', sans-serif",cursor:"pointer"}}}>TEST</Typography>
                                          </Box>
                                      ...
                                      <Box textAlign={"center"}>
                                           ...
                                           <Box className='maintext' >
                                             <Typography className='text-1' variant='h1' fontWeight={700} sx={{marginTop:{lg:"-96px",md:"-96px",sm:"-76px",xs:"-50px"},fontSize:{lg:"96px",md:"96px",sm:"66px",xs:"36px"},fontFamily:"'Raleway', sans-serif",cursor:"pointer"}}>Your</Typography>
                                          </Box>
                                           <img src={crafter3} alt="" className='gameimg' style={{paddingTop:"20px",width:{xs:"100%"},height:"100pox"}} />
                                      </Box>
                                 </Box>
                                 <Box className='maintext' >
                                      <Typography className='text-1' textAlign={"center"} fontWeight={700} sx={{marginTop:{lg:"-100px",md:"-96px",sm:"-76px",xs:"-30px"},fontSize:{lg:"96px",md:"96px",sm:"66px",xs:"36px"},fontFamily:"'Raleway', sans-serif",cursor:"pointer"}}>LIMITS</Typography>
                                 </Box>
                             </Box>
                        </Grid>
                    </Grid>
