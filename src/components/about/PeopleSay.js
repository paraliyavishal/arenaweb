import { Avatar, Box, Button, Container, Grid, Rating, Stack, Typography } from '@mui/material'
...
function PeopleSay() {
  ...
  return (
    <Box sx={{ backgroundColor: "#070929", paddingTop: "80px", paddingBottom: "80px" }}>
      <Container maxWidth='xl'>
        <Grid container item xs={12} display={"flex"} justifyContent={"center"} spacing={3}>
          <Grid item xs={12} sm={10} md={6} lg={6} spacing={3} sx={{ color: "white", alignItems: "center", display: "flex" }}>
            <Box >
              <Box sx={{ textAlign: { lg: "start", md: "start", sm: "center", xs: "center" } }}>
                <Typography sx={{ fontSize: { lg: "48px", md: "48px", sm: "34px", xs: "34px" }, fontWeight: "700", fontFamily: "'Rajdhani', sans-serif" }}>WHAT PEOPLE SAY </Typography>
                <Typography sx={{ fontSize: { lg: "48px", md: "48px", sm: "34px", xs: "34px" }, fontWeight: "700", fontFamily: "'Rajdhani', sans-serif" }}>ABOUT US​ </Typography>
              ...
              <Slider ref={sliderRef} {...settings}>
                {people.map((item, index) => (
                  <Box key={index} sx={{ backgroundColor: "#2B2A65", }}>
                    <Box padding={4}>
                      <Typography sx={{ fontSize: { lg: "18px", md: "18px", sm: "16px", xs: "16px" }, lineHeight: "36px", color: "white", fontWeight: "500", fontFamily: "'Raleway', sans-serif" }}>
                        Excellent Service
                      </Typography>
                      <Typography sx={{ fontSize: { lg: "16px", md: "16px", sm: "14px", xs: "12px" }, color: "#BFBFBF", fontFamily: "'Raleway', sans-serif" }}>
                        {item.text}
                      </Typography>
                      <Box sx={{ marginTop: "50px" }}>
                        <Stack direction="row" alignItems="center" spacing={2}>
                          ...
                          <Box>
                            <Typography component="legend" sx={{ color: "white", fontSize: { lg: "18px", md: "18px", sm: "16px", xs: "16px" }, fontFamily: "'Raleway', sans-serif" }}>{item.name}</Typography>
