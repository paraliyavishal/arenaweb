...
function Aboutherosection() {
  ...
  return (
    <Box
      sx={{
        backgroundImage: `linear-gradient(rgba(40, 17, 43, 0.541),rgba(40, 17, 43, 0.521)),url(${bgimg})`,
      ...
      >
        <Box sx={{ marginTop: "200px", paddingBottom: "55px" }}>
          ...
          >
            <Typography
              py={2}
              sx={{ fontFamily: "Rajdhani, sans-serif", color: "white" }}
              fontWeight={700}
              variant="h2"
            >
              ABOUT US
            ...
            <div onClick={handleClick}>
              <Breadcrumbs
                ...
                separator={
                  <NavigateNextIcon sx={{ color: "#fff" }} fontSize="medium" />
                }
